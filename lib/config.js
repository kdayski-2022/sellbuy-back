...
const getConfigByEnv = (env) => {
  let SWA, PCA, CN, CGP, CL, IP, BE, PTAL, D, TA, CLE, RCA, CNET, MODE;
  WTA = null;
  switch (env) {
    case 'production':
      SWA = {
      ...
      RCA = {
        1: REFERRAL_CONTRACT_ADDRESS[1],
        42161: REFERRAL_CONTRACT_ADDRESS[42161],
      };
      CNET = CHAIN_NETWORKS;
      MODE = 'production';
      break;
    case 'development':
      ...
      RCA = {
        1: REFERRAL_CONTRACT_ADDRESS[1],
        42161: REFERRAL_CONTRACT_ADDRESS[42161],
        80001: REFERRAL_CONTRACT_ADDRESS[80001],
        421613: REFERRAL_CONTRACT_ADDRESS[421613],
      };
      CNET = CHAIN_NETWORKS;
      MODE = 'development';
      break;
