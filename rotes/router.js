...
router.put('/ref_code/:ref_code', userController.editReferral);
router.post('/ref_code/:ref_code/remove', userController.removeRefCode);
router.post('/ref_code/:address/generate', userController.generateRefCode);
